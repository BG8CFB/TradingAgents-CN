...
const DOMAIN_DESCRIPTIONS: Record<string, string> = {
  ...
  northbound_flow: '沪股通、深股通每日资金流向数据，用于追踪外资对A股的资金配置动向。',
  northbound_holding: '沪深股通持股明细，反映外资对个股的持仓变动和投资偏好。',
  share_unlock: '限售股解禁数据，用于预判减持压力和评估个股流动性风险。',
  pledge: '股权质押统计数据，用于评估大股东质押比例和爆仓风险。',
  trading_status: '每日停复牌信息，用于排除停牌期间的异常数据和监控复牌动态。',
  price_limit: '每日涨跌停价格数据，用于监控涨跌停板和评估个股波动性。',
  index_data: '指数日线行情和成分权重数据，用于跟踪大盘走势和行业轮动。',
  chip_distribution: '每日筹码分布和胜率数据，用于分析主力持仓成本和套牢盘分布。',
  sw_daily: '申万行业指数日行情，用于板块强弱分析和行业轮动研究。',
  ths_daily: '同花顺概念/行业板块行情，用于热点板块追踪和概念分析。',
  forecast: '上市公司业绩预告数据，预判业绩变化方向和幅度。',
  express: '上市公司业绩快报，提前获取营收、净利润等核心财务数据。',
