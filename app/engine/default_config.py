...
DEFAULT_CONFIG = {
    ...
    "online_tools": get_env("ONLINE_TOOLS_ENABLED", "false").lower() == "true",
    "online_news": get_env("ONLINE_NEWS_ENABLED", "true").lower() == "true", 
    "realtime_data": get_env("REALTIME_DATA_ENABLED", "false").lower() == "true",
