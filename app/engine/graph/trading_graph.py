...
from app.engine.llm_adapters import ChatDashScopeOpenAI, ChatGoogleOpenAI
...
def create_llm_by_provider(provider: str, model: str, backend_url: str, temperature: float, max_tokens: int, timeout: int, api_key: str = None):
    ...
    Returns:
        LLM 实例
    """
    from app.engine.llm_adapters.deepseek_adapter import ChatDeepSeek
    from app.engine.llm_adapters.openai_compatible_base import create_openai_compatible_llm
...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        if quick_provider and deep_provider and quick_provider != deep_provider:
            ...
            from app.engine.llm_adapters.openai_compatible_base import ChatZhipuOpenAI
